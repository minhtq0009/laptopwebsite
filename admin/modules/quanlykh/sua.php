<?php
	$sql_sua_kh = "SELECT * FROM tbl_dangky WHERE id_khachhang='$_GET[iddangky]' LIMIT 1";
...
<form method="POST" action="modules/quanlykh/xuly.php?iddangky=<?php echo $row['id_khachhang'] ?>" enctype="multipart/form-data" class="dangky">
